        ...
        <div class="col-12">
          <div class="card">
              ...
              @endif
                ...
                <div class="col-lg-12">
                <form action="/Datasiswa/{{$siswa->id}}/update" method="POST" enctype="multipart/form-data">
                    @csrf
                      <div class="form-group">
                        <label for="exampleInputEmail1">Nama</label>
                        <input name='nama' type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" value="{{$siswa->nama}}">
                      ...
                      <div class="form-group">
                        ...
                        <select name='kom_keahlian' class="custom-select">
                          <option value="RPL" @if ($siswa->kom_keahlian == 'RPL') selected @endif>RPL</option>
                          <option value="TKJ" @if ($siswa->kom_keahlian == 'TKJ') selected @endif>TKJ</option>
                          <option value="MMD" @if ($siswa->kom_keahlian == 'MMD') selected @endif>MMD</option>
                        </select>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail1">NIS</label>
                        <input name='nis'type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" value="{{$siswa->nis}}">
                        <small id="emailHelp" class="form-text text-muted"></small>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input name='kelas'type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" value="{{$siswa->kelas}}">
                        <small id="emailHelp" class="form-text text-muted"></small>
                      </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">No. HP</label>
                      <input name='nohp'type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" value="{{$siswa->nohp}}">
                      <small id="emailHelp" class="form-text text-muted"></small>
                    </div>   
                    <div class="form-group">
                      <label for="exampleInputEmail1">Nama Orang Tua/Wali</label>
                      <input name='nama_orangtua'type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" value="{{$siswa->nama_orangtua}}">
                      <small id="emailHelp" class="form-text text-muted"></small>
                    </div> 
                    <div class="form-group">
                      <label for="exampleInputEmail1">No. HP Orang Tua/Wali</label>
                      <input name='nohp_orangtua'type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="" value="{{$siswa->nohp_orangtua}}">
                      <small id="emailHelp" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                    ...
                    <input name='previous_url'type="text" class="form-control" value="{{url()->previous()}}" hidden>
                    <div class="modal-footer">
                        <a href="{{ url()->previous() }}" class="btn btn-secondary" role="button" aria-pressed="true">Close</a>
